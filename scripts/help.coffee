...
module.exports = (robot) ->
  robot.respond /ヘルプ|コマンド/i, (msg) ->
    ...
    massege += "> 　修正出社 [YYYY/MM/DD] [hh:mm or DEL] - 指定した日時の出社時間を修正する ※DELは内容をクリアします \n"
    massege += "> 　修正退社 [YYYY/MM/DD] [hh:mm or DEL] - 指定した日時の退社時間を修正する ※DELは内容をクリアします \n"
    massege += "> 　修正備考 [YYYY/MM/DD] [備考 or DEL] - 指定した日時の備考を修正する ※DELは内容をクリアします \n"
